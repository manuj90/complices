			...
			<AnimatePresence>
				{open && (
					<motion.div
						...
						<div className='h-16 shrink-0 border-b border-border/60 sm:h-18' />
						...
						<div className='flex shrink-0 items-center justify-center border-t border-border/60 px-6 py-6 pb-[max(1.5rem,env(safe-area-inset-bottom))]'>
							<button
								type='button'
								onClick={toggleLang}
								aria-label={
