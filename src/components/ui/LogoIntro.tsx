    ...
    <div className={cn('flex flex-col items-center', className)}>
      <div className="relative flex items-center justify-center">
        <img
          ...
          draggable={false}
          className={cn(
            'relative z-10 block h-24 w-auto sm:h-28 md:h-32 lg:h-36 xl:h-40',
            FACE_OVERLAP_CLASS,
          )}
        />
        <img
          ...
          alt="Cómplices"
          draggable={false}
          className="relative z-0 block h-24 w-auto sm:h-28 md:h-32 lg:h-36 xl:h-40"
        />
      </div>
      ...
      <img
        ...
        alt=""
        draggable={false}
        className="mt-4 h-auto w-[min(88vw,320px)] sm:mt-5 sm:w-[min(78vw,360px)] lg:w-[min(72vw,380px)]"
      />
    </div>
  )
}